    ...
    <section className="our-team-info my-12 grid grid-cols-1 md:grid-cols-2 gap-4 px-12 bg-neutral overflow-x-hidden">
      <div className="team-one">
        <div className="hero h-screen">
          <div className="hero-content bg-white p-8 rounded-lg flex-col lg:flex-row">
            <img
              alt=""
              src={team2}
            ...
            />
            <div>
              <h1 className="text-xl font-bold">Kate Smith</h1>
      ...
      <div className="team-two">
        <div className="hero h-screen">
          <div className="hero-content bg-white p-8 rounded-lg flex-col lg:flex-row">
            ...
            />
            <div className="">
              <h1 className="text-xl font-bold">Jose Aldo</h1>
              <h3 className="text-base text-primary font-bold">
                Carts parts Manager
              </h3>
              <p className="py-6">
                Head of the sales department for over 5 years. Sphere of

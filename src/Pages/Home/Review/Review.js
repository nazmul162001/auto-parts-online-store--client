...
const Review = () => {
  ...
  return (
    <section className="user-review h-96 mb-[150px]">
      <h2 className="text-center text-5xl text-primary font-bold opacity-60">Customer Review</h2>
      <div className='h-1 bg-primary w-1/5 mx-auto opacity-60 mt-2'></div>
      <h3 className="text-center text-gray-500 text-xl font-bold">What Our Customer Say About Parts Online Store</h3>
